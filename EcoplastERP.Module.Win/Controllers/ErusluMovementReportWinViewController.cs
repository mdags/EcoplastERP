...
{
    public partial class ErusluMovementReportWinViewController : ViewController
    {
        public ErusluMovementReportWinViewController()
        {
            InitializeComponent();
        ...
        private void RefreshAction_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            ...
            if (cvi != null)
            {
                ErusluMovementReportUserControl userControl = cvi.Control as ErusluMovementReportUserControl;
        ...
        private void ExportErusluMovementReportAction_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            ControlViewItem cvi = ((DashboardView)View).Items[0] as ControlViewItem;
            if (cvi != null)
            {
