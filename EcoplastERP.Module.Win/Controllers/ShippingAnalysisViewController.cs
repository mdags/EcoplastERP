...
{
    public partial class ShippingAnalysisViewController : ViewController
    {
        public ShippingAnalysisViewController()
        {
            InitializeComponent();
        ...
        private void RefreshAction_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            ...
            if (cvi != null)
            {
                ShippingAnalysisUserControl userControl = cvi.Control as ShippingAnalysisUserControl;
        ...
        private void ExportShippingAnalysisAction_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            ControlViewItem cvi = ((DashboardView)View).Items[0] as ControlViewItem;
            if (cvi != null)
            {
