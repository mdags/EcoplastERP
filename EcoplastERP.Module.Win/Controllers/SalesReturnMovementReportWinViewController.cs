...
{
    public partial class SalesReturnMovementReportWinViewController : ViewController
    {
        public SalesReturnMovementReportWinViewController()
        {
            InitializeComponent();
        ...
        private void RefreshAction_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            ...
            if (cvi != null)
            {
                SalesReturnMovementReportUserControl userControl = cvi.Control as SalesReturnMovementReportUserControl;
        ...
        private void SalesReturnMovementReportAction_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            ControlViewItem cvi = ((DashboardView)View).Items[0] as ControlViewItem;
            if (cvi != null)
            {
