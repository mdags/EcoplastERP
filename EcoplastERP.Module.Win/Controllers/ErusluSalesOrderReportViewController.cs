...
{
    public partial class ErusluSalesOrderReportViewController : ViewController
    {
        public ErusluSalesOrderReportViewController()
        {
            InitializeComponent();
        }
        ...
        private void RefreshAction_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            ...
            if (cvi != null)
            {
                ErusluSalesOrderReportUserControl userControl = cvi.Control as ErusluSalesOrderReportUserControl;
                userControl.RefreshGrid();
            }
        }

        private void ExportErusluSalesOrderReportAction_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            ControlViewItem cvi = ((DashboardView)View).Items[0] as ControlViewItem;
            if (cvi != null)
            {
