...
{
    public partial class StorePastReportWinViewController : ViewController
    {
        public StorePastReportWinViewController()
        {
            InitializeComponent();
        ...
        private void RefreshAction_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            ...
            if (cvi != null)
            {
                StorePastReportUserControl userControl = cvi.Control as StorePastReportUserControl;
                userControl.RefreshGrid();
            }
        }

        private void ExportStorePastReportAction_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            ControlViewItem cvi = ((DashboardView)View).Items[0] as ControlViewItem;
            if (cvi != null)
            {
