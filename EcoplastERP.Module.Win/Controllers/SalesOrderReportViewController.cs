...
{
    public partial class SalesOrderReportViewController : ViewController
    {
        public SalesOrderReportViewController()
        {
            InitializeComponent();
        ...
        private void ExportSalesOrderReportAction_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            ControlViewItem cvi = ((DashboardView)View).Items[0] as ControlViewItem;
            if (cvi != null)
            {
