...
{
    public partial class MachineCapacityTargetReportViewController : ViewController
    {
        public MachineCapacityTargetReportViewController()
        {
            InitializeComponent();
        ...
        private void RefreshAction_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            ...
            if (cvi != null)
            {
                MachineCapacityTargetReportUserControl userControl = cvi.Control as MachineCapacityTargetReportUserControl;
                userControl.RefreshGrid();
            }
        }

        private void ExportMachineCapacityTargetReportAction_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            ControlViewItem cvi = ((DashboardView)View).Items[0] as ControlViewItem;
            if (cvi != null)
            {
