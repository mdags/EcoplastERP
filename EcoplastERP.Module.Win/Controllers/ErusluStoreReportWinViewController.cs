...
{
    public partial class ErusluStoreReportWinViewController : ViewController
    {
        public ErusluStoreReportWinViewController()
        {
            InitializeComponent();
        ...
        private void RefreshAction_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            ...
            if (cvi != null)
            {
                ErusluStoreReportUserControl userControl = cvi.Control as ErusluStoreReportUserControl;
        ...
        private void ErusluStoreReportSelectTypeAction_Execute(object sender, SingleChoiceActionExecuteEventArgs e)
        {
            ControlViewItem cvi = ((DashboardView)View).Items[0] as ControlViewItem;
            if (cvi != null)
            {
        ...
        private void ExportErusluStoreReportAction_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            ControlViewItem cvi = ((DashboardView)View).Items[0] as ControlViewItem;
            if (cvi != null)
            {
