<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="transferlogin.aspx.cs" Inherits="EcoplastERP.PTC.transferlogin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="select Oid, UserName from WarehouseTransferUser where GCRecord is null order by UserName"></asp:SqlDataSource>
</asp:Content>
