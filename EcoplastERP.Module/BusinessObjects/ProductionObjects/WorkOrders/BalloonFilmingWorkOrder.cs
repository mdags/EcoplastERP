...
namespace EcoplastERP.Module.BusinessObjects.ProductionObjects
{
    ...
    [Appearance("BalloonFilmingWorkOrder.LineDeliveryDateAppearance", TargetItems = "WorkName", Criteria = "SalesOrderDetail.LineDeliveryDate < LocalDateTimeToday()", BackColor = "MistyRose")]
    [Appearance("BalloonFilmingWorkOrder.TotalProductionQuantityAppearance", TargetItems = "TotalProduction", Criteria = "TotalProduction > Quantity", BackColor = "GreenYellow")]
    [Appearance("BalloonFilmingWorkOrder.TotalProductionQuantityAppearance1", TargetItems = "TotalProduction", Criteria = "TotalProduction <= Quantity", BackColor = "LemonChiffon")]
    [Appearance("BalloonFilmingWorkOrder.CompletedAppearance", TargetItems = "*", Criteria = "WorkOrderStatus = 'ProductionComplete'", FontStyle = FontStyle.Strikeout, BackColor = "LemonChiffon")]
    [Appearance("BalloonFilmingWorkOrder.CanceledAppearance", TargetItems = "*", Criteria = "WorkOrderStatus = 'Canceled'", FontStyle = FontStyle.Strikeout, BackColor = "MistyRose")]
    [Appearance("BalloonFilmingWorkOrder.QuarantineQuantityAppearance", TargetItems = "*", Criteria = "QuarantineQuantity > 0", BackColor = "PowderBlue", Context = "BalloonFilmingWorkOrder_ListView")]
    [Appearance("BalloonFilmingWorkOrder_MachineLoad.QuarantineQuantityAppearance", TargetItems = "*", Criteria = "QuarantineQuantity > 0", BackColor = "PowderBlue", Context = "BalloonFilmingWorkOrder_ListView_MachineLoad")]
    public class BalloonFilmingWorkOrder : BaseObject
    {
        public BalloonFilmingWorkOrder(Session session)
            : base(session)
        {
        }
        public override void AfterConstruction()
        {
            ...
            Station = Session.FindObject<Station>(CriteriaOperator.Parse("Name = 'Balonlu Çekim'"));
        ...
        protected override void OnSaving()
        {
            ...
            if (Session.Connection != null && Session.IsObjectToSave(this))
            {
                ...
                foreach (var item in BalloonFilmingWorkOrderParts)
                {
                ...
                foreach (BalloonFilmingWorkOrderReciept reciept in BalloonFilmingWorkOrderReciepts)
                {
                    decimal partThickness = 0;
                    foreach (BalloonFilmingWorkOrderPart part in BalloonFilmingWorkOrderParts)
                    {
            ...
            //BalloonFilmingWorkOrderParts.Sorting.Add(new SortProperty("MachinePart.Name", DevExpress.Xpo.DB.SortingDirection.Ascending));
            ...
            //BalloonFilmingWorkOrderReciepts.Sorting.Add(new SortProperty("MachinePart.Name", DevExpress.Xpo.DB.SortingDirection.Ascending));
            //var sbReciept = new StringBuilder();
            //foreach (var item in BalloonFilmingWorkOrderParts)
            //{
            //    BalloonFilmingWorkOrderReciepts.Filter = new BinaryOperator("MachinePart.Name", item.MachinePart.Name);
            //    foreach (var reciept in BalloonFilmingWorkOrderReciepts)
            //    {
        ...
        {
            base.OnDeleting();
            //var cuttingWorkOrder = Session.FindObject<CuttingWorkOrder>(CriteriaOperator.Parse(string.Format("SalesOrderDetail.Oid = '{0}'", SalesOrderDetail.Oid)));
            //if (cuttingWorkOrder == null)
            //{
            //    var printingWorkOrder = Session.FindObject<PrintingWorkOrder>(CriteriaOperator.Parse(string.Format("SalesOrderDetail.Oid = '{0}'", SalesOrderDetail.Oid)));
            ...
            //        else if (SalesOrderDetail.SalesOrderStatus == SalesOrderStatus.WaitingforProduction) SalesOrderDetail.SalesOrderStatus = SalesOrderStatus.WaitingforBalloonFilming;
            //    }
        ...
        [Appearance("BalloonFilmingWorkOrder.WorkName", Context = "DetailView", Enabled = false, Criteria = "1 = 1")]
        ...
        public decimal TotalProduction
        {
            get
            {
                return Convert.ToDecimal(Session.Evaluate(typeof(Production), CriteriaOperator.Parse("Sum(GrossQuantity)"), CriteriaOperator.Parse("BalloonFilmingWorkOrder = ?", Oid)));
            }
        }
        ...
        public decimal TotalWastage
        {
            get
            {
                return Convert.ToDecimal(Session.Evaluate(typeof(Wastage), CriteriaOperator.Parse("Sum(GrossQuantity)"), CriteriaOperator.Parse("BalloonFilmingWorkOrder = ?", Oid)));
            }
        }
        ...
        [Appearance("BalloonFilmingWorkOrder.PaletteStickerDesign", Context = "DetailView", Visibility = ViewItemVisibility.Hide, Criteria = "NextStation.Name != 'Son Üretim'")]
        ...
        [Appearance("BalloonFilmingWorkOrder.BellowsBellowsStatus", Context = "DetailView", Visibility = ViewItemVisibility.Hide, Criteria = "BellowsStatus = 'None'")]
        ...
        [Appearance("BalloonFilmingWorkOrder.Cap", Context = "DetailView", Visibility = ViewItemVisibility.Hide, Criteria = "CapStatus = 'Uncapped'")]
        public decimal Cap
        {
            get
            {
        ...
        [Appearance("BalloonFilmingWorkOrder.CoronaDirection", Context = "DetailView", Visibility = ViewItemVisibility.Hide, Criteria = "Corona = 'Doesnt'")]
        ...
        [Appearance("BalloonFilmingWorkOrder.CoronaCoronaType", Context = "DetailView", Visibility = ViewItemVisibility.Hide, Criteria = "Corona != 'OneSidePartial' and Corona != 'DoubleSidePartial'")]
        ...
        [Appearance("BalloonFilmingWorkOrder.ShippingPackageType", Context = "DetailView", Visibility = ViewItemVisibility.Hide, Criteria = "NextStation.Name != 'Son Üretim'")]
        ...
        [Appearance("BalloonFilmingWorkOrder.ShippingFilmType", Context = "DetailView", Visibility = ViewItemVisibility.Hide, Criteria = "NextStation.Name != 'Son Üretim'")]
        [RuleRequiredField(DefaultContexts.Save, TargetCriteria = "NextStation.Name = 'Son Üretim'")]
        ...
        [Appearance("BalloonFilmingWorkOrder.Palette", Context = "DetailView", Visibility = ViewItemVisibility.Hide, Criteria = "NextStation.Name != 'Son Üretim'")]
        ...
        [Appearance("BalloonFilmingWorkOrder.PaletteLayout", Context = "DetailView", Visibility = ViewItemVisibility.Hide, Criteria = "NextStation.Name != 'Son Üretim'")]
        ...
        [Appearance("BalloonFilmingWorkOrder.PaletteNumber", Context = "DetailView", Enabled = false, Criteria = "1 = 1")]
        [VisibleInDetailView(false)]
        ...
        public XPCollection<BalloonFilmingWorkOrderPart> BalloonFilmingWorkOrderParts
        {
            get { return GetCollection<BalloonFilmingWorkOrderPart>("BalloonFilmingWorkOrderParts"); }
        }

        [Association, Aggregated]
        public XPCollection<BalloonFilmingWorkOrderReciept> BalloonFilmingWorkOrderReciepts
        {
            get { return GetCollection<BalloonFilmingWorkOrderReciept>("BalloonFilmingWorkOrderReciepts"); }
        }
        ...
        void GetSalesOrderDetail()
        {
            ...
            {
                var balloonFilmingWorkOrder = Session.FindObject<BalloonFilmingWorkOrder>(new BinaryOperator("SalesOrderDetail", SalesOrderDetail.Oid));
                if (balloonFilmingWorkOrder != null) XtraMessageBox.Show(string.Format("Bu müşteri siparişi için daha önce {0} numaralı üretim siparişi doldurulmuş. Mükerrer bir kayıt olup olmadığını kontrol ediniz...", balloonFilmingWorkOrder.WorkOrderNumber), "Bilgilendirme", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Information);
        ...
        void GetReciept()
        {
            ...
            if (Reciept != null)
            {
                XPCollection<BalloonFilmingWorkOrderReciept> balloonFilmingReciepts = BalloonFilmingWorkOrderReciepts;
                Session.Delete(balloonFilmingReciepts);
                ...
                foreach (var item in Reciept.RecieptDetails)
                {
                    ...
                    var balloonFilmingWorkOrderReciept = new BalloonFilmingWorkOrderReciept(Session)
                    {
                        BalloonFilmingWorkOrder = this,
                        Product = item.Product,
                        Warehouse = item.Warehouse,
                        MachinePart = _part != null ? _part : null,
                        WorkOrderRate = item.Rate,
                        Unit = item.Unit
                    };
                    this.BalloonFilmingWorkOrderReciepts.Add(balloonFilmingWorkOrderReciept);
                }
            ...
            BalloonFilmingWorkOrderReciepts.Filter = null;
        }
