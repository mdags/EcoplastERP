...
namespace EcoplastERP.Module.BusinessObjects.ProductionObjects
{
    ...
    public class BalloonCuttingWorkOrder : BaseObject
    {
        public BalloonCuttingWorkOrder(Session session)
            : base(session)
        {
        }
        public override void AfterConstruction()
        {
            ...
            Station = Session.FindObject<Station>(CriteriaOperator.Parse("Name = 'Balonlu Kesim'"));
        ...
        protected override void OnSaving()
        {
            ...
            //    BalloonCuttingWorkOrderReciept.Sorting.Add(new SortProperty("Product.Name", DevExpress.Xpo.DB.SortingDirection.Ascending));
            //var sbReciept = new StringBuilder();
            //foreach (var reciept in BalloonCuttingWorkOrderReciept)
            //{
            //    sbReciept.AppendLine(String.Format("{0} - %{1:n1} / ", reciept.Product.Name, reciept.Rate));
        ...
        {
            base.OnDeleting();
            //SalesOrderDetail.SalesOrderStatus = SalesOrderStatus.WaitingforBalloonCutting;
        }
        // Fields...
        ...
        [Appearance("BalloonCuttingWorkOrder.WorkName", Context = "DetailView", Enabled = false, Criteria = "1 = 1")]
        ...
        public decimal TotalProduction
        {
            get
            {
                return Convert.ToDecimal(Session.Evaluate(typeof(Production), CriteriaOperator.Parse("Sum(GrossQuantity)"), CriteriaOperator.Parse("BalloonCuttingWorkOrder = ?", Oid)));
            }
        }
        ...
        public decimal TotalWastage
        {
            get
            {
                return Convert.ToDecimal(Session.Evaluate(typeof(Wastage), CriteriaOperator.Parse("Sum(GrossQuantity)"), CriteriaOperator.Parse("BalloonCuttingWorkOrder = ?", Oid)));
            }
        }
        ...
        [Appearance("BalloonCuttingWorkOrder.PaletteStickerDesign", Context = "DetailView", Visibility = ViewItemVisibility.Hide, Criteria = "NextStation.Name != 'Son Üretim'")]
        ...
        [Appearance("BalloonCuttingWorkOrder.BellowsBellowsStatus", Context = "DetailView", Visibility = ViewItemVisibility.Hide, Criteria = "BellowsStatus = 'None'")]
        ...
        [Appearance("BalloonCuttingWorkOrder.Cap", Context = "DetailView", Visibility = ViewItemVisibility.Hide, Criteria = "CapStatus = 'Uncapped'")]
        public decimal Cap
        {
            get
            {
        ...
        [Appearance("BalloonCuttingWorkOrder.DeckCount", Context = "DetailView", Visibility = ViewItemVisibility.Hide, Criteria = "InnerPacking != null")]
        ...
        [Appearance("BalloonCuttingWorkOrder.OuterPackingPackageCount", Context = "DetailView", Visibility = ViewItemVisibility.Hide, Criteria = "OuterPacking = null")]
        ...
        [Appearance("BalloonCuttingWorkOrder.InnerPackingPieceCount", Context = "DetailView", Visibility = ViewItemVisibility.Hide, Criteria = "InnerPacking = null")]
        ...
        [Appearance("BalloonCuttingWorkOrder.PaletteNumber", Context = "DetailView", Enabled = false, Criteria = "1 = 1")]
        [VisibleInDetailView(false)]
        ...
        [Aggregated, Association("BalloonCuttingWorkOrder-BalloonCuttingWorkOrderReciept", typeof(BalloonCuttingWorkOrderReciept))]
        public XPCollection<BalloonCuttingWorkOrderReciept> BalloonCuttingWorkOrderReciept
        {
            get { return GetCollection<BalloonCuttingWorkOrderReciept>("BalloonCuttingWorkOrderReciept"); }
        }
        ...
        void GetSalesOrderDetail()
        {
            ...
            {
                var cuttingWorkOrder = Session.FindObject<BalloonCuttingWorkOrder>(new BinaryOperator("SalesOrderDetail", SalesOrderDetail.Oid));
                if (cuttingWorkOrder != null) XtraMessageBox.Show(String.Format("Bu müşteri siparişi için daha önce {0} numaralı üretim siparişi doldurulmuş. Mükerrer bir kayıt olup olmadığını kontrol ediniz...", cuttingWorkOrder.WorkOrderNumber), "Bilgilendirme", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Information);
                ...
                Session.Delete(this.BalloonCuttingWorkOrderReciept);
                BalloonCuttingWorkOrderReciept reciept = new BalloonCuttingWorkOrderReciept(Session)
                {
                    BalloonCuttingWorkOrder = this,
                ...
                BalloonCuttingWorkOrderReciept.Add(reciept);
            }
        }
        ...
        void GetReciept()
        {
            ...
            if (Reciept != null)
            {
                ...
                {
                    var balloonCuttingWorkOrderReciept = new BalloonCuttingWorkOrderReciept(Session)
                    {
                        BalloonCuttingWorkOrder = this,
                    ...
                    this.BalloonCuttingWorkOrderReciept.Add(balloonCuttingWorkOrderReciept);
                }
    ...
    [ImageName("BO_List")]
    [NavigationItem(false)]
    public class BalloonCuttingWorkOrderReciept : BaseObject
    {
        public BalloonCuttingWorkOrderReciept(Session session)
            : base(session)
        {
        }
        public override void AfterConstruction()
        ...
        protected override void OnSaving()
        {
            ...
            if (Session.IsNewObject(this))
            {
                ...
                {
                    if (BalloonCuttingWorkOrder.Station != null) Warehouse = BalloonCuttingWorkOrder.Station.SourceWarehouse;
                }
            }
            if (BalloonCuttingWorkOrder != null)
            {
                BalloonCuttingWorkOrder.BalloonCuttingWorkOrderReciept.Sorting.Add(new SortProperty("Product.Name", DevExpress.Xpo.DB.SortingDirection.Ascending));
                var sbReciept = new StringBuilder();
                foreach (var reciept in BalloonCuttingWorkOrder.BalloonCuttingWorkOrderReciept)
                {
                    sbReciept.AppendLine(String.Format("{0} - %{1:n1} / ", reciept.Product.Name, reciept.Rate));
                }
                BalloonCuttingWorkOrder.RecieptString = sbReciept.ToString();
            }
        }
        // Fields...
        ...
        protected BalloonCuttingWorkOrder _BalloonCuttingWorkOrder;

        [Persistent, Association("BalloonCuttingWorkOrder-BalloonCuttingWorkOrderReciept")]
        public BalloonCuttingWorkOrder BalloonCuttingWorkOrder
        {
            get { return _BalloonCuttingWorkOrder; }
            set
            {
        ...
        {
            if (IsLoading) return;
            Quantity = BalloonCuttingWorkOrder.Quantity * Rate / 100;
        }
