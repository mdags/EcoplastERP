...
namespace EcoplastERP.Module.BusinessObjects.ProductionObjects
{
    ...
    [Appearance("LaminationWorkOrder.LineDeliveryDateAppearance", TargetItems = "WorkName", Criteria = "SalesOrderDetail.LineDeliveryDate < LocalDateTimeToday()", BackColor = "MistyRose")]
    [Appearance("LaminationWorkOrder.TotalProductionQuantityAppearance", TargetItems = "TotalProduction", Criteria = "TotalProduction > Quantity", BackColor = "GreenYellow")]
    [Appearance("LaminationWorkOrder.TotalProductionQuantityAppearance1", TargetItems = "TotalProduction", Criteria = "TotalProduction <= Quantity", BackColor = "LemonChiffon")]
    [Appearance("LaminationWorkOrder.CompletedAppearance", TargetItems = "*", Criteria = "WorkOrderStatus = 'ProductionComplete'", FontStyle = FontStyle.Strikeout, BackColor = "LemonChiffon")]
    [Appearance("LaminationWorkOrder.CanceledAppearance", TargetItems = "*", Criteria = "WorkOrderStatus = 'Canceled'", FontStyle = FontStyle.Strikeout, BackColor = "MistyRose")]
    [Appearance("LaminationWorkOrder.QuarantineQuantityAppearance", TargetItems = "*", Criteria = "QuarantineQuantity > 0", BackColor = "PowderBlue", Context = "LaminationWorkOrder_ListView")]
    [Appearance("LaminationWorkOrder_MachineLoad.QuarantineQuantityAppearance", TargetItems = "*", Criteria = "QuarantineQuantity > 0", BackColor = "PowderBlue", Context = "LaminationWorkOrder_ListView_MachineLoad")]
    public class LaminationWorkOrder : BaseObject
    {
        public LaminationWorkOrder(Session session)
            : base(session)
        {
        }
        public override void AfterConstruction()
        {
            ...
            Station = Session.FindObject<Station>(CriteriaOperator.Parse("Name = 'Laminasyon'"));
        ...
        protected override void OnSaving()
        {
            ...
            //LaminationWorkOrderReciepts.Sorting.Add(new SortProperty("Product.Name", DevExpress.Xpo.DB.SortingDirection.Ascending));
            //var sbReciept = new StringBuilder();
            //foreach (var reciept in LaminationWorkOrderReciepts)
            //{
        ...
        {
            base.OnDeleting();
            SalesOrderDetail.SalesOrderStatus = SalesOrderStatus.WaitingforLamination;
        }
        // Fields...
        ...
        [Appearance("LaminationWorkOrder.WorkName", Context = "DetailView", Enabled = false, Criteria = "1 = 1")]
        ...
        public decimal TotalProduction
        {
            get
            {
                return Convert.ToDecimal(Session.Evaluate(typeof(Production), CriteriaOperator.Parse("Sum(GrossQuantity)"), CriteriaOperator.Parse("LaminationWorkOrder = ?", Oid)));
            }
        }
        ...
        public decimal TotalWastage
        {
            get
            {
                return Convert.ToDecimal(Session.Evaluate(typeof(Wastage), CriteriaOperator.Parse("Sum(GrossQuantity)"), CriteriaOperator.Parse("LaminationWorkOrder = ?", Oid)));
            }
        }
        ...
        [Appearance("LaminationWorkOrder.PaletteStickerDesign", Context = "DetailView", Visibility = ViewItemVisibility.Hide, Criteria = "NextStation.Name != 'Son Üretim'")]
        ...
        [RuleValueComparison("LaminationWorkOrder.RollWeight", DefaultContexts.Save, ValueComparisonType.GreaterThan, 0)]
        ...
        [RuleValueComparison("LaminationWorkOrder.MaximumRollWeight", DefaultContexts.Save, ValueComparisonType.GreaterThan, 0)]
        ...
        [Appearance("LaminatingWorkOrder.PaletteNumber", Context = "DetailView", Enabled = false, Criteria = "1 = 1")]
        [VisibleInDetailView(false)]
        ...
        public XPCollection<LaminationWorkOrderReciept> LaminationWorkOrderReciepts
        {
            get { return GetCollection<LaminationWorkOrderReciept>("LaminationWorkOrderReciepts"); }
        }
        ...
        void GetSalesOrderDetail()
        {
            ...
            {
                var laminationWorkOrder = Session.FindObject<LaminationWorkOrder>(new BinaryOperator("SalesOrderDetail", SalesOrderDetail.Oid));
                if (laminationWorkOrder != null) XtraMessageBox.Show(string.Format("Bu müşteri siparişi için daha önce {0} numaralı üretim siparişi doldurulmuş. Mükerrer bir kayıt olup olmadığını kontrol ediniz...", laminationWorkOrder.WorkOrderNumber), "Bilgilendirme", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Information);
                ...
                XPCollection delReciept = new XPCollection(Session, typeof(LaminationWorkOrderReciept), new BinaryOperator("Product.Oid", SalesOrderDetail.Product.Oid));
                Session.Delete(delReciept);
                LaminationWorkOrderReciept reciept = new LaminationWorkOrderReciept(Session)
                {
                    LaminationWorkOrder = this,
                ...
                LaminationWorkOrderReciepts.Add(reciept);
            }
        }
        void GetReciept()
        {
            ...
            if (Reciept != null)
            {
                XPCollection<LaminationWorkOrderReciept> cuttingReciepts = LaminationWorkOrderReciepts;
                Session.Delete(cuttingReciepts);
                foreach (var item in Reciept.RecieptDetails)
                {
                    var reciept = new LaminationWorkOrderReciept(Session)
                    {
                        LaminationWorkOrder = this,
                    ...
                    this.LaminationWorkOrderReciepts.Add(reciept);
                }
