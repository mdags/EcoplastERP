...
namespace EcoplastERP.Module.Editors
{
    /// <summary>
    ...
    public abstract class CustomUserControlViewItem : ViewItem, IComplexViewItem
    {
        ...
        protected override void OnControlCreated()
        {
            ...
            XpoSessionAwareControlInitializer.Initialize(Control as IXpoSessionAwareControl, theObjectSpace, theApplication);
        }
    }
    /// <summary>
    ...
    {
        //void UpdateDataSource(Session session, IObjectSpace os, XafApplication app);
        void UpdateDataSource(XafApplication app);
    }
    public static class XpoSessionAwareControlInitializer
    {
        public static void Initialize(IXpoSessionAwareControl control, IObjectSpace objectSpace, XafApplication app)
        {
            ...
            //Type persistentDataType = typeof(Production);
            //IList persistentData = objectSpace.GetObjects(persistentDataType);
            ...
            //control.UpdateDataSource(xpObjectSpace.Session, objectSpace, app);
            control.UpdateDataSource(app);
        ...
        {
            Initialize(sessionAwareControl, theApplication != null ? theApplication.CreateObjectSpace() : null, theApplication);
        }
    }
}
